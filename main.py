...
optimal_rotor = OptimalRotor(fluid_properties=file_fluid_properties,
                             operative_state=file_operative_state,
                             hydrofoils=file_hydrofoils)
optimal_rotor.get_design_points()
optimal_rotor.get_optimal_chord_twist(path=POLAR_PLOTS_FOLDER_PATH)
optimal_rotor.save_properties(path=OPTIMAL_ROTOR_FOLDER_PATH)
